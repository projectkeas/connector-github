...
func TestPullRequestMapping(t *testing.T) {
	src := map[string]interface{}{
		...
		"merge_commit_sha":    "21fds1ds32f1sd2",
	...
	expected := map[string]interface{}{
		...
		"base": map[string]interface{}{
			...
			"ref":   "master",
			"repo": map[string]interface{}{
				"cloneUris": map[string]string{
					"https": "https://github.com/Codertocat/Hello-World.git",
					"ssh":   "git@github.com:Codertocat/Hello-World.git",
				},
		...
		"body":         "This is a pretty simple change that we need to pull into master.",
		"changedFiles": 1,
		"closedAt":     "2019-05-15T15:20:33Z",
		"commits":      1,
		"createdAt":    "2019-05-15T15:20:33Z",
		"deletions":    1,
		...
		"mergeCommitSha":      "21fds1ds32f1sd2",
		"mergeableState":      "unknown",
		"mergedAt":            "2019-05-15T15:20:33Z",
		"mergedBy":            "test",
		"milestone":           map[string]interface{}{},
		"number":              2,
